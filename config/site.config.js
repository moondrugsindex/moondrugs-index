...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'nhatnam.repo@wq64c.onmicrosoft.com',
  ...
  googleFontSans: 'Playwrite Ireland',
  // googleFontMono - the monospace font used in onedrive-cf-index-ng.
  googleFontMono: 'Patrick Hand SC',
  // googleFontLinks -  an array of links for referencing the google font assets.
  googleFontLinks: ['https://googledonts.private.coffee/css2?family=Playwrite+Ireland&family=Patrick+Hand+SC:wght@400;500;700&display=swap'],

  // [OPTIONAL] The footer component of your website. You can write HTML here, but you need to escape double
  // quotes - changing " to \". You can write anything here, and if you like badges, generate some with https://shields.io
  footer:
    'Powered by <a href="https://github.com/nhatnamrepo" target="_blank" rel="noopener noreferrer">melbel</a>. Made with fatpeoples.',
  ...
  email: 'mailto:lucida_igonnagetdone@protonmail.com',
  ...
  datetimeFormat: 'HH:mm:ss in DD-MM-YYYY',
